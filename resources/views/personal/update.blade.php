    ...
    <div class="col-lg-5">
        <main class="form-update-personal">
            ...
            <form action="/updatePersonal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-floating">
                    <input type="date" name="expired_at" class="form-control @error('expired_at')is-invalid @enderror" id="expired_at" placeholder="{{ $user->expire_at }}" required value="{{ $user->expired_at }}">
